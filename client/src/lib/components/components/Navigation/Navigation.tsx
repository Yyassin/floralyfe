...
import { auth, plantData } from "lib/store/mock";
		...
		<Box>
			...
			>
				...
				>
					...
					>
						<Heading as="h1" size="md">
							<Flex
								alignItems={"center"}
							>
								<Image src={logo} width={55} height={40}/>
								<Link ml={3} href="/">floralyfe</Link>
							</Flex>
                        </Heading> 
					...
					<Flex 
                        display={{ base: "none", lg: auth ? "flex" : "none"}} 
                        ml={10} 
                        width="100%" 
                        justify="center" 
                        align="center"
								...
								{	auth &&
									plantData.map((plant, idx) => (
										<Badge 
											...
											borderRadius='full' 
											px='2' 
											colorScheme={isSelected(plant.id) ? "green" : "gray"}
			...
			<motion.div
				...
				style={{
					background: useColorModeValue("white", "var(--chakra-colors-gray-700)"),
					overflow: "hidden",
					whiteSpace: "nowrap",
					position: "absolute",
					left: "0",
